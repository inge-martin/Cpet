...
<section class="content">
    <?php     if(empty($mascota)){        echo "<h3>Aun no hay mascotas Finadas.</h3>";    }else{        ?>
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                ...
                <h3 class="box-title">Mascotas Finadas</h3> 
                    <br><a href="<?php echo base_url('Empleado/Mascotas'); ?>" style="padding: 0; margin: 0; font-size: 12px">Mascotas Registradas</a>
                </div>
                <div class="box-body">
                    <table id="datatable1" class="table table-bordered table-striped">
                        ...
                        <?php foreach ($mascota as $mascota_item): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url('Empleado/Mascotas/viewF/'.$mascota_item['id_mascota']); ?>">
