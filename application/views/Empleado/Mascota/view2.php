			...
			<div class="col-md-6">
				<div class="box box-primary">
					...
					<div class="box-body box-profile">
						...
						<h4 class="text-center">Dueño: <a href="<?php echo base_url('Empleado/Clientes/view/'.$mascota['id_cliente']); ?>"><?php echo ucwords($mascota['dueño'] . " " . $mascota['ap_paterno']); ?></a>
						</h4>												
				...
				<form class="form-horizontal">
					<div class="box box-primary">
						...
						<div class="box-footer">
							<td><a href="<?php echo base_url('Empleado/Mascotas/finadas'); ?>" class="btn btn-info pull-right">Regresar</a></td>
						</div>
					</div>
				</form>
			</div>
