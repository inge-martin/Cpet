          ...
          <div class="box box-primary">
            ...
            <div class="box-body box-profile">
              ...
              <h3 class="profile-username text-center">
                <a href="<?php echo base_url('Empleado/Mascotas/view/'.$vacunas[$i]['id_mascota']); ?>"><?php echo ucwords($vacunas[$i]['mascota']); ?> / <?php echo ucwords($vacunas[$i]['raza']); ?></a>
              </h3>                      
              <ul class="list-group list-group-unbordered">             
                ...
                <li class="list-group-item">
                  <b>Dueño:</b> <a class="pull-right" href="<?php echo base_url('Empleado/Clientes/view/'.$vacunas[$i]['id_cliente']); ?>"><?php echo ucwords($vacunas[$i]['cliente'] . " " .$vacunas[$i]['cli_p'] . " " .$vacunas[$i]['cli_m']); ?></a>
                </li>
                <li class="list-group-item">
                  <b>Zootécnico:</b><a class="pull-right"><?php echo ucwords($vacunas[$i]['zoo'] . " " .$vacunas[$i]['zoo_p'] . " " .$vacunas[$i]['zoo_m']); ?></a>
                </li>  
                <li class="list-group-item">
                  <b>Clínica:</b> <a class="pull-right" href="<?php echo base_url('Empleado/Clinicas/view/'.$vacunas[$i]['id_clinica']); ?>"><?php echo ucwords($vacunas[$i]['clinica']); ?></a>
                </li>                                  
              </ul>
            </div>
          </div>
        ...
        <div class="col-md-6"> 
          <div class="box box-primary">
            ...
            <div class="box-footer">
              <td><a href="<?php echo base_url('Empleado/Vacunacion'); ?>" class="btn btn-info pull-right">Regresar</a></td>
            </div>
          </div>
        </div>  
