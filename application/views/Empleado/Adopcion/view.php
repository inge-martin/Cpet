				...
				<div class="box box-primary">
					...
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-8">
								<a><p class="form-control-static"><?php echo $adopcion['descripcion']; ?></p></a>
							</div>
							</div>
							...
							<div class="col-sm-12">
								<td><a href="<?php echo base_url('Empleado/Adopciones'); ?>" class="btn btn-info pull-right">Regresar</a></td>
							</div>
						</div>												
					</div>
				</div>
