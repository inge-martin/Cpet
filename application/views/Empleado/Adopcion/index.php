...
<section class="content">
    ...
    <a href="<?php echo base_url('Empleado/Adopciones/newAdopcion'); ?>" class='btn btn-success'>
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Adopciones</h3> <a href="<?php echo base_url('Empleado/Adopciones/newAdopcion'); ?>" class="btn btn-success btn-sm pull-right"><i class="fa fa-plus"></i> Nueva Adopción</a>
                </div> 
                <div class="box-body">
                        ...
                        <tbody>
                            <?php foreach ($adopcion as $adopcion_item): ?>
                                <tr>
                                    ...
                                    <td>                               
                                        <a href="<?php echo base_url('Empleado/Adopciones/view/'.$adopcion_item['id_adopcion']); ?>">
                                            <span class="label label-primary">Ver</span>
                                        </a>
                                        <!-- <a href="<?php echo base_url('Empleado/Adopciones/edit/'.$adopcion_item['id_adopcion']); ?>">
                                            <span class="label label-success">Editar</span>
                                        </a>  
                                        <a href="<?php echo base_url('Empleado/Adopciones/delete/'.$adopcion_item['id_adopcion']); ?>" onClick="return confirm('¿Estas seguro que quieres borrarlo?')">
