...
<section class="content">
    ...
    <a href="<?php echo base_url('Empleado/Extravio/newEx'); ?>" class='btn btn-success'>
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Extravios</h3> <a href="<?php echo base_url('Empleado/Extravio/newEx'); ?>" class="btn btn-success btn-sm pull-right"><i class="fa fa-plus"></i> Nuevo Extravio</a>
                </div> 
                <div class="box-body">
                        ...
                        <tbody>
                            <?php foreach ($extravio as $extravio_item): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url('Empleado/Extravio/view/'.$extravio_item['id_extravio']); ?>">
                                            <span class="label label-primary">Ver</span>
                                        </a>
                                        <a href="<?php echo base_url('Empleado/Extravio/edit/'.$extravio_item['id_extravio']); ?>">
