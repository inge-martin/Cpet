					...
					<ul class="list-group list-group-unbordered">
						...
						foreach ($mascota as $list) {
							...
							<li class="list-group-item">
								<b>Mascota:</b> 
								<a href="<?php echo base_url('Empleado/Mascotas/view/'.$list['id_mascota']); ?>" class="pull-right">
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<p class="form-control-static"><a><?php echo ucwords($cliente['numero']); ?></a> </p>
							</div>
						...
						<td><a href="<?php echo base_url('Empleado/Clientes'); ?>" class="btn btn-info pull-right">Regresar</a></td>
					</div>
				</div>
			</form>
		</div>		
