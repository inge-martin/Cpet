            ...
            <div class="box box-primary">
                ...
                <div class="box-body box-profile">
                    ...
                    <ul class="list-group list-group-unbordered">
                        ...
                        <li class="list-group-item">
                            <b>F. Nacimiento:</b> <a class="pull-right"><?php echo date("d-m-Y" , strtotime($empleado['fecha_nacimiento'])); ?></a>
                        </li>
                        <li class="list-group-item">
                            <b>Email:</b> <a class="pull-right"><?php echo $empleado['email']; ?></a>
                        </li>
                        <li class="list-group-item">
                            <b>Rol de empleado:</b> <a class="pull-right"><?php echo $empleado['rol']; ?></a>
                        </li>                                                  
                        <li class="list-group-item">
                            <b>Jefe Zootécnico:</b> <a class="pull-right"><?php echo ucwords($empleado['zoo'] . " " . $empleado['zoo_p']); ?></a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <p class="form-control-static"><a><?php echo ucwords($empleado['lote']); ?> /<?php echo ucwords($empleado['manzana']); ?></a></p><p><br><br></p>
                            </div>
                        </div>
                    </div>
                </div>
