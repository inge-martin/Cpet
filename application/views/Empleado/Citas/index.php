...
<section class="content">
    ...
    <a href="<?php echo base_url('Empleado/Citas/newCita'); ?>" class='btn btn-success'>
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Citas</h3> <a href="<?php echo base_url('Empleado/Citas/newCita'); ?>" class="btn btn-success btn-sm pull-right"><i class="fa fa-plus"></i> Nueva Cita</a>
                </div> 
                <div class="box-body">
                        ...
                        <tbody>
                            <?php foreach ($citas as $citas_item): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url('Empleado/Citas/generar/'.$citas_item['id_citas']); ?>">
                                            <span class="label label-primary">Imprimir</span>
                                        </a>
                                        <a href="<?php echo base_url('Empleado/Citas/edit/'.$citas_item['id_citas']); ?>">
