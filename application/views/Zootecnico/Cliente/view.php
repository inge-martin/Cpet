					...
					<ul class="list-group list-group-unbordered">
						...
						foreach ($mascota as $list) {
							...
							<li class="list-group-item">
								<b>Mascota:</b> 
								<a href="<?php echo base_url('Zootecnico/Mascotas/view/'.$list['id_mascota']); ?>" class="pull-right">
			...
			<form class="form-horizontal">
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<td><a href="<?php echo base_url('Zootecnico/Clientes'); ?>" class="btn btn-info pull-right">Regresar</a></td>
					</div>
				</div>
			</form>
		</div>		
