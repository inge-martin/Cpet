<section class="content">
  ...
  ?>
  <form class="form-horizontal" action="<?php echo base_url(); ?>Zootecnico/Clientes/nuevoCli" method="POST" enctype="multipart/form-data" name="formulario">

    <!-- /.Datos Principales -->
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">Datos Principales del Cliente</h3>
      </div>
      <div class="box-body">
        <div class="box-body">
          <div class="form-group"> 
            ...
            <div class="col-sm-4">
              <input type="text" class="form-control" id="nombre" placeholder="Ingresa tu nombre" name="txtNombre" required onkeypress="return soloLetras(event)" maxlength="15" autofocus>
            </div>                    
          </div>           
          <div class="form-group">
      ...
      <div class="box-body">
        <div class="box-body">
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <input type="text" class="form-control" id="usuario" autocomplete="false" placeholder="Ingresa tu Usuario" name="txtUsuario" required maxlength="15" onkeypress="return letraNumero(event)">
              <div id="resultado1" style="font-weight: bold;"></div>                
            </div>                                        
          </div>
          <div class="form-group">
