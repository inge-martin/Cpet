        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <p class="form-control-static"><a><?php echo $clinica['numero'] . " / " . $clinica['numero_int']; ?></a> </p>
              </div>
              <label for="nombre" class="col-sm-4 control-label">Lote / Manzana:</label>
              <div class="col-sm-8">
                <p class="form-control-static"><a><?php echo ucwords($clinica['lote']); ?> /<?php echo ucwords($clinica['manzana']); ?></a></p>
              </div>
            </div>
            <a href="<?php echo base_url('Zootecnico/Clinicas'); ?>" class="btn btn-info pull-right">Regresar</a>
          </div>
        </div>
      </form>
    </div>      
