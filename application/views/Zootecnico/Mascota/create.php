<section class="content">
  ...
  ?>
  <form class="form-horizontal" action="<?php echo base_url(); ?>Zootecnico/Mascotas/nuevaMascota" method="POST" enctype="multipart/form-data" name="formulario">
        ...
        <div class="box-body">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <select class="col-sm-3 form-control" name="id_cliente" required>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" id="nombre" placeholder="Ingresa nombre de la mascota" name="txtNombre" required onkeypress="return soloLetras(event)" maxlength="25">
              </div>
            </div>            
            <div class="form-group">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">                             
              ...
              <div class="col-sm-8">
                <input type="number" step="any" class="form-control" placeholder="5.2" name="txtPeso" required maxlength="10" min="-9999.99" max="9999.99">
              </div>
            </div>
            <div class="form-group">                         
