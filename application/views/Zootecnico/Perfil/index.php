                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <p class="form-control-static"><a><?php echo ucwords($zootecnico['numero'] . " / " . $zootecnico['numero_int']); ?></a> </p>
                            </div>
                            <label for="nombre" class="col-sm-4 control-label">Lote / Manzana:</label>
                            <div class="col-sm-8">
                                <p class="form-control-static"><a><?php echo ucwords($zootecnico['lote']); ?> /<?php echo ucwords($zootecnico['manzana']); ?></a></p><br>
                            </div>
                        </div>
                    </div>
                </div>
