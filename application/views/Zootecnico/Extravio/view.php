      ...
      <div class="box box-primary">
        ...
        <div class="box-body box-profile">
          ...
          <h3 class="profile-username text-center">
            <?php echo ucfirst($extravio['Mascota']); ?>
          </h3>
          <ul class="list-group list-group-unbordered">
            <li class="list-group-item">
              <b>Raza:</b> <a class="pull-right"><?php echo ucfirst($extravio['Raza']); ?></a>
            </li>
            <li class="list-group-item">
              <b>Sexo:</b> <a class="pull-right"><?php echo ucfirst($extravio['sexo']); ?></a>
            </li>
            <li class="list-group-item">
              <b>Color:</b> <a class="pull-right"><?php echo ucfirst($extravio['color']);; ?></a>
            </li>                                   
            <li class="list-group-item">
              <b>Descripción:</b> <a class="pull-right"><?php echo ucfirst($extravio['descripcion']);; ?></a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <p class="form-control-static"><a><?php echo ucfirst($extravio['senas_particulares']); ?></a></p>
          </div>
          <div class="form-group">
            <label for="exampleInputPassword1">Donde se extravió:</label>
            <p class="form-control-static"><a><?php echo ucfirst($extravio['ubicacion']); ?></a></p>
          </div>
          <div class="form-group">
            <label for="exampleInputPassword1">Estado de la mascota:</label>
            <p class="form-control-static"><a><?php echo ucfirst($extravio['status']); ?></a></p>
          </div>                        
        </div>
        <br>
        <div class="box-footer">
          <a href="<?php echo base_url('Zootecnico/Extravio'); ?>" class="btn btn-info pull-right">Regresar</a>
        </div>
      </div>
    </div>  
  </div>
