...
<section class="content">
  ...
  if(!empty(validation_errors())){
    ...
    <div class="row">
      <div class="col-md-12">
        <form class="form-horizontal" action="<?php echo base_url(); ?>Zootecnico/Extravio/editar_extravio" method="POST">
          <div class="box box-primary">
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <p class="form-control-static"><?php echo ucwords($extravio['Mascota']); ?></p>
                </div>
              </div>          
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="date" class="form-control" name="fecha_extravio" required="true" value="<?php echo $extravio['fecha_extravio'] ?>" max="<?php echo $fecha_actual; ?>">
