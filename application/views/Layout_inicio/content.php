  ...
  <div class="col-md-6">
    <div class="box box-solid">
        <div class="box-header with-border">
          <h3 class="box-title">Animales Fantasticos</h3>
        </div>
        <!-- /.box-header -->
      <div class="box-body">
  ...
  <div class="col-xs-12">
    <div class="box box-success">
      <div class="box-header">
        <h3 class="box-title">Porcentaje de animales atendidos en nuestras sucursales.</h3>
      </div>
      <!-- /.box-header -->
      <div class="box-body">
        <div class="row margin">
          <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-aqua">
              <div class="inner">
                <h3><?php //echo round($porcentajeA); ?>35<sup style="font-size: 20px">%</sup></h3>
              ...
              <p class="small-box-footer">De 100 animales.</p>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-green">
              <div class="inner">
                <h3><?php //echo round($porcentajeB); ?>35<sup style="font-size: 20px">%</sup></h3>
          ...
          <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-yellow">
              <div class="inner">
                <h3><?php //echo round($porcentajeC); ?>20<sup style="font-size: 20px">%</sup></h3>
          ...
          <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-red">
              <div class="inner">
                <h3><?php //echo round($porcentajeD); ?>10<sup style="font-size: 20px">%</sup></h3>
