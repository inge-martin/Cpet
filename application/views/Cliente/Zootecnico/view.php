    ...
    <div class="row">
        <div class="col-md-6">
            <div class="box box-primary">
                ...
                <h3 class="box-title">Zootécnico encargado</h3>
                    <?php 
                ...
                <div class="box-body box-profile">
                    ...
                    <h3 class="profile-username text-center">
                        <?php echo ucwords($zootecnico['zoo']. " " .$zootecnico['ap_paterno'] . " " . $zootecnico['ap_materno'] ); ?>
                    </h3>
                    <h4 class="text-center">Labora en: <a href="<?php echo base_url('Cliente/Clinicas/view/'.$zootecnico['id_clinica']); ?>"><?php echo ucwords($zootecnico['clinica']); ?></a>
                    </h4>
                    <ul class="list-group list-group-unbordered">
                        ...
                        <li class="list-group-item">
                            <b>F. Nacimiento:</b> <a class="pull-right"><?php echo date("d-m-Y", strtotime($zootecnico['fecha_nacimiento'])); ?></a>
                        </li>
                        <li class="list-group-item">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <p class="form-control-static"><a><?php echo ucwords($zootecnico['lote']); ?> /<?php echo ucwords($zootecnico['manzana']); ?></a><br></p>
                            </div>
                        </div>
                    </div>
                </div>
