                ...
                <div class="box-body box-profile">
                    ...
                    <ul class="list-group list-group-unbordered">
                        <li class="list-group-item">
                            <b>Usuario:</b> <a class="pull-right"><?php echo $cliente['usuario']; ?></a>
                        </li>
                        <li class="list-group-item">
                            <b>Sexo:</b> <a class="pull-right"><?php echo ucwords($cliente['sexo']); ?></a>
                        </li>                       
                        <li class="list-group-item">
                            <b>F. Nacimiento:</b> <a class="pull-right"><?php echo date("d-m-Y", strtotime($cliente['fecha_nacimiento'])); ?></a>
                        </li>
                        <li class="list-group-item">
                        ...
                        foreach ($mascota as $list) {
                            ...
                            <li class="list-group-item">
                                <b>Mascota:</b> 
                                <a href="<?php echo base_url('Cliente/Mascotas/view/'.$list['id_mascota']); ?>" class="pull-right">
                        ...
                        ?>
                        <li class="list-group-item">
                            <b>Zotécnico encargado:</b> <a href="<?php echo base_url('Cliente/Zootecnico'); ?>" class="pull-right"><?php echo ucwords($cliente['zoo'] . " " . $cliente['zoo_p']); ?></a>
                        </li>                                                                       
                    </ul>
                </div>
            </div>
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <p class="form-control-static"><a><?php echo ucwords($cliente['lote']); ?> /<?php echo ucwords($cliente['manzana']); ?></a></p><p><br><br></p>
                            </div>
                        </div>
                    </div>
                </div>
