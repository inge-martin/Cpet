...
<!-- <body class="hold-transition skin-green-light layout-boxed sidebar-mini"> -->
  <div class="wrapper">
    <header class="main-header">
      <!-- Logo -->
      <a href="<?php echo base_url(); ?>Cliente/Inicio" class="logo">
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="<?php echo base_url(); ?>assets/image/fotos/cliente/<?php echo $this->session->userdata('s_fotografia'); ?>" class="user-image" alt="User Image">
                <span class="hidden-xs"><?php echo strtoupper($this->session->userdata('s_nombre') . " " .  $this->session->userdata('s_ap_paterno')); ?></span>
              </a>
              <ul class="dropdown-menu">
                <!-- User image -->
                <li class="user-header">
                  <img src="<?php echo base_url(); ?>assets/image/fotos/cliente/<?php echo $this->session->userdata('s_fotografia'); ?>" class="img-circle" alt="User Image">

                  <p>
                    <?php echo strtoupper($this->session->userdata('s_nombre') . " " .  $this->session->userdata('s_ap_paterno')); ?>
                    <!-- <small>Cliente del sistema</small> -->
                ...
                <li class="user-footer">
                  <div class="pull-left">
                    <a href="<?php echo base_url(); ?>Cliente/Perfil" class="btn btn-default btn-flat">
