...
<section class="content">
    <form class="form-horizontal" action="<?php echo base_url(); ?>Administrador/Expediente/generar" method="POST">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-info col-sm-6" value="Guardar">Buscar Expediente</button>
                </div>
            </div>
