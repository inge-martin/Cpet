...
<section class="content">
    ...
    <a href="<?php echo base_url('Administrador/Clientes/newCli'); ?>" class='btn btn-success'>
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Clientes</h3> <a href="<?php echo base_url('Administrador/Clientes/newCli'); ?>" class="btn btn-success btn-sm pull-right"><i class="fa fa-plus"></i> Nuevo Cliente</a>
                </div> 
                <div class="box-body">
                    <table id="datatable1" class="table table-bordered table-striped">
                        ...
                        <?php foreach ($cliente as $cliente_item): ?>
                            <tr>
                                <td><?php echo ucwords($cliente_item['id_cliente']); ?></td>
                                <td><?php echo ucwords($cliente_item['zootecnico'] . " " .$cliente_item['zoo_paterno'] . " " .$cliente_item['zoo_materno']); ?></td>
                                <td>
                                ...
                                <td>
                                    <a href="<?php echo base_url('Administrador/Clientes/view/'.$cliente_item['id_cliente']); ?>">
