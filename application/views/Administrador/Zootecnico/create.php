<section class="content">
  ...
  ?>
  <form class="form-horizontal" action="<?php echo base_url(); ?>Administrador/Zootecnicos/nuevoZoo" method="POST" enctype="multipart/form-data" name="formulario">

    <!-- /.Datos Principales -->
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">Datos Principales del Zootecnico</h3>
      </div>
      <div class="box-body">
        <div class="box-body">
          <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">Clínica asignada:</label>
            <div class="col-sm-4">
              <select class="col-sm-3 form-control select2" name="id_clinica" required>
      ...
      <div class="box-body">
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <input type="text" class="form-control" id="input1" placeholder="Ingresa tu cedula" name="txtCedula" maxlength="13" onkeypress="return letraNumero(event)" required="required">
            </div>                 
          </div>
        </div><!-- /.box-body -->
      </div>
