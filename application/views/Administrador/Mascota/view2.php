			...
			<div class="col-md-6">
				<div class="box box-primary">
					...
					<div class="box-body box-profile">
						...
						<h4 class="text-center">Dueño: <a href="<?php echo base_url('Administrador/Clientes/view/'.$mascota['id_cliente']); ?>"><?php echo ucwords($mascota['dueño'] . " " . $mascota['ap_paterno']); ?></a>
						</h4>												
						<ul class="list-group list-group-unbordered">
							...
							<li class="list-group-item">
								<b>F. Nacimiento:</b> <a class="pull-right">								<?php echo date("d-m-Y", strtotime($mascota['fecha_nacimiento'])); ?></a>
							</li>
							<li class="list-group-item">
					...
					<div class="box box-primary">
						...
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<a><p class="form-control-static"><?php echo ucwords($mascota['Raza']); ?></p></a>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<a><p class="form-control-static" style="height: 107px;" ><?php echo ucwords($mascota['descripcion']); ?></p></a>
								</div>
							</div>
						</div>
						<div class="box-footer">
							<td><a href="<?php echo base_url('Administrador/Mascotas/finadas'); ?>" class="btn btn-info pull-right">Regresar</a></td>
						</div>
					</div>
				</form>
			</div>
