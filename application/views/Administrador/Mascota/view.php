				...
				<div class="box box-primary">
					...
					<div class="box-body box-profile">
						...
						<ul class="list-group list-group-unbordered">
							...
							<li class="list-group-item">
								<b>F. Nacimiento:</b> <a class="pull-right"><?php echo ucwords($mascota['fecha_nacimiento']); ?></a>
							</li>
							<li class="list-group-item">
				...
				<form class="form-horizontal">
					<div class="box box-primary">
						...
						<div class="box-footer">
							<td><a href="<?php echo base_url('Administrador/Mascotas'); ?>" class="btn btn-info pull-right">Regresar</a></td>
						</div>
					</div>
				</form>
			</div>
