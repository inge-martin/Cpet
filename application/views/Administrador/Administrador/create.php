<section class="content">
  ...
  ?>
  <form class="form-horizontal" action="<?php echo base_url(); ?>Administrador/Administradores/nuevoAdmin" method="POST" enctype="multipart/form-data" name="formulario">

    <!-- /.Datos Principales -->
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">Datos Principales del Administrador</h3>
      </div>
      <div class="box-body">
        <div class="box-body">
    ...
    <div class="box  box-primary">
      ...
      <div class="box-body">
        <div class="box-body">
          ...
          <div class="form-group">
            <label for="input1" class="col-sm-2 control-label">Pregunta seguridad:</label>
            <div class="col-sm-4">
