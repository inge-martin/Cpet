		...
		<div class="col-md-6">
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title">Perfil del Administrador</h3>
					<?php 
				...
				<div class="box-body box-profile">
					...
					<h3 class="profile-username text-center">
						<?php echo ucwords($administrador['nombre']); ?>
						<br>
						<?php echo ucwords($administrador['ap_paterno'] . " " . $administrador['ap_materno']); ?>
					</h3>
					<ul class="list-group list-group-unbordered">
						...
						<li class="list-group-item">
							<b>F. Nacimiento:</b> <a class="pull-right"><?php echo ucwords($administrador['fecha_nacimiento']); ?></a>
						</li>
						<li class="list-group-item">
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<p class="form-control-static"><a><?php echo $administrador['numero'] ." / " . $administrador['numero_int'] ; ?></a> </p>
							</div>
							<label for="nombre" class="col-sm-4 control-label">Lote / Manzana:</label>
							<div class="col-sm-8">
								<p class="form-control-static"><a><?php echo ucwords($administrador['lote']); ?> /<?php echo ucwords($administrador['manzana']); ?></a></p>
							</div>
						</div>
						<td><a href="<?php echo base_url('Administrador/Administradores'); ?>" class="btn btn-info pull-right">Regresar</a></td>
					</div>
				</div>
			</form>
		</div>		
