...
class Mascotas extends CI_Controller{
    ...
    public function __construct(){
        parent::__construct();
        $this->load->model('Zootecnico/Mascota_model');
    }
    ...
    public function index(){
        ...
        $this->load->view('Zootecnico/Mascota/index', $data);
    ...
    public function finadas(){
        ...
        $this->load->view('Zootecnico/Layout_zoo/header');
        $this->load->view('Zootecnico/Layout_zoo/menu');
        $this->load->view('Zootecnico/Mascota/index2', $data);
        $this->load->view('Zootecnico/Layout_zoo/footer');
    }
    ...
    public function view($id_admin){
        ...
        $this->load->view('Zootecnico/Layout_zoo/header');
        $this->load->view('Zootecnico/Layout_zoo/menu');
        $this->load->view('Zootecnico/Mascota/view', $data);
        $this->load->view('Zootecnico/Layout_zoo/footer');
    }

    public function viewF($id_admin){
        $data['mascota'] = $this->Mascota_model->get_detalle_mascota1($id_admin);
        ...
        $this->load->view('Zootecnico/Layout_zoo/header');
        $this->load->view('Zootecnico/Layout_zoo/menu');
        $this->load->view('Zootecnico/Mascota/view2', $data);
        $this->load->view('Zootecnico/Layout_zoo/footer');
    }
    ...
    public function newPet(){
        ...
        $this->load->view('Zootecnico/Layout_zoo/header');
        $this->load->view('Zootecnico/Layout_zoo/menu');
        $this->load->view('Zootecnico/Mascota/create', $data);
        $this->load->view('Zootecnico/Layout_zoo/footer');         
    }
    ...
    public function nuevaMascota(){      
        ...
        if (!$this->upload->do_upload("txtFotografia")) {
            ...
            $this->load->view('Zootecnico/Layout_zoo/header');
            $this->load->view('Zootecnico/Layout_zoo/menu');
            $this->load->view('Zootecnico/Mascota/success');
            $this->load->view('Zootecnico/Layout_zoo/footer');
        }
    }
    ...
    public function delete(){
        ...
        redirect( base_url() . 'Zootecnico/Mascotas');
    }
