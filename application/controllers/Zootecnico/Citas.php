...
class Citas extends CI_Controller{
	...
	{
		parent::__construct();
		$this->load->model('Zootecnico/Citas_model');
	}
	...
	public function index(){
		...
		$this->load->view('Zootecnico/Citas/index', $data);
	...
	public function newCita(){
		...
		$this->load->view('Zootecnico/Layout_zoo/header');
		$this->load->view('Zootecnico/Layout_zoo/menu');
		$this->load->view('Zootecnico/Citas/create', $data);
		$this->load->view('Zootecnico/Layout_zoo/footer');
	}
	...
	public function nuevaCita1(){
		...
		$this->load->view('Zootecnico/Layout_zoo/header');
		$this->load->view('Zootecnico/Layout_zoo/menu');
		$this->load->view('Zootecnico/Citas/success', $data);
		$this->load->view('Zootecnico/Layout_zoo/footer');
	}
	...
	public function editar_cita(){
		...
		redirect( base_url() . 'Zootecnico/Citas/');
	} 
	...
	public function edit(){
		...
		$this->load->view('Zootecnico/Layout_zoo/header');
		$this->load->view('Zootecnico/Layout_zoo/menu');
		$this->load->view('Zootecnico/Citas/edit', $data);
		$this->load->view('Zootecnico/Layout_zoo/footer');
	}
	...
	public function generar($id_citas){
		...
		$html = $this->load->view('Zootecnico/Citas/imprimir', $data, true);
