...
class Expediente extends CI_Controller{
    ...
    public function __construct(){
        parent::__construct();
        $this->load->model('Zootecnico/Expediente_model');
    }
    ...
    public function index(){
        ...
        $this->load->view('Zootecnico/Expediente/index', $data);
    ...
    public function view(){
        ...
        $this->load->view('Zootecnico/Expediente/imprimir', $data);
    }
    ...
    public function generar(){
        ...
        $html = $this->load->view('Zootecnico/Expediente/imprimir', $data, true);

        //this the the PDF filename that user will get to download
        $pdfFilePath = "Clinic-pet-Expediente-".$fecha."_".$hora.".pdf";
