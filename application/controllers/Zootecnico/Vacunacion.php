...
class Vacunacion extends CI_Controller{
    ...
    public function __construct(){
        parent::__construct();
        $this->load->model('Zootecnico/Vacunacion_model');
    }
    ...
    public function index(){
        ...
        $this->load->view('Zootecnico/Vacunacion/index', $data);
    ...
    public function view($id_mascota){
        ...
        $this->load->view('Zootecnico/Layout_zoo/header');
        $this->load->view('Zootecnico/Layout_zoo/menu');
        $this->load->view('Zootecnico/Vacunacion/view', $data);
        $this->load->view('Zootecnico/Layout_zoo/footer');
    }
    ...
    public function newVacuna(){
        ...
        $this->load->view('Zootecnico/Layout_zoo/header');
        $this->load->view('Zootecnico/Layout_zoo/menu');
        $this->load->view('Zootecnico/Vacunacion/create', $data);
        $this->load->view('Zootecnico/Layout_zoo/footer');         
    }
    ...
    public function descargar($id_mascota){
        ...
        $html = $this->load->view('Zootecnico/Vacunacion/imprimir', $data, true);
