...
class Clientes extends CI_Controller{
	...
	public function __construct(){
		parent::__construct();
		$this->load->model('Zootecnico/Cliente_model');
	}
	...
	public function index(){
		...
		$this->load->view('Zootecnico/Cliente/index', $data);
	...
	public function view($id_cliente){
		...
		if (empty($data['mascota'])){
			...
			$this->load->view('Zootecnico/Layout_zoo/header');
			$this->load->view('Zootecnico/Layout_zoo/menu');
			$this->load->view('Zootecnico/Cliente/add_pet');
			$this->load->view('Zootecnico/Layout_zoo/footer');
		}else{
			$this->load->view('Zootecnico/Layout_zoo/header');
			$this->load->view('Zootecnico/Layout_zoo/menu');
			$this->load->view('Zootecnico/Cliente/view', $data);
			$this->load->view('Zootecnico/Layout_zoo/footer');
		}
	}
	...
	public function newCli(){
		...
		$this->load->view('Zootecnico/Layout_zoo/header');
		$this->load->view('Zootecnico/Layout_zoo/menu');
		$this->load->view('Zootecnico/Cliente/create', $data);
		$this->load->view('Zootecnico/Layout_zoo/footer');         
	}
	...
	public function nuevoCli(){
		...
		if (!$this->upload->do_upload("txtFotografia")) {
			...
			$paramCZ['id_zootecnico']   = $this->session->userdata('s_id_zootecnico');
			...
			$this->load->view('Zootecnico/Layout_zoo/header');
			$this->load->view('Zootecnico/Layout_zoo/menu');
			$this->load->view('Zootecnico/Cliente/success');
			$this->load->view('Zootecnico/Layout_zoo/footer');
		}   
	} 
