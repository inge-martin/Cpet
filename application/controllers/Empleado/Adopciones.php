...
class Adopciones extends CI_Controller{
    ...
    public function view($id_adopcion = 0){
        ...
        $this->load->view('Empleado/Layout_emp/header');
        $this->load->view('Empleado/Layout_emp/menu');
        $this->load->view('Empleado/Adopcion/view', $data);
        $this->load->view('Empleado/Layout_emp/footer');
    }
    ...
    public function newAdopcion(){
        ...
        $this->load->view('Empleado/Layout_emp/header');
        $this->load->view('Empleado/Layout_emp/menu');
        $this->load->view('Empleado/Adopcion/create', $data);
        $this->load->view('Empleado/Layout_emp/footer');         
    }
    ...
    public function nuevaAdopcion(){      
        ...
        if (!$this->upload->do_upload("fotografia")) {
            ...
            $this->load->view('Empleado/Layout_emp/header');
            $this->load->view('Empleado/Layout_emp/menu');
            $this->load->view('Empleado/Adopcion/success');
            $this->load->view('Empleado/Layout_emp/footer');
        }
    }
    ...
    public function editar_adopcion(){
        ...
        redirect( base_url() . 'Empleado/Adopciones/view/'.$paramAdopcion['id_adopcion']);
    } 
    ...
    public function edit(){
        ...
        $this->load->view('Empleado/Layout_emp/header');
        $this->load->view('Empleado/Layout_emp/menu');
        $this->load->view('Empleado/Adopcion/edit', $data);
        $this->load->view('Empleado/Layout_emp/footer');
    }
    ...
    public function delete(){
        ...
        redirect( base_url() . 'Empleado/Adopciones');
    }
