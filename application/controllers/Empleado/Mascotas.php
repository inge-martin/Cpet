...
class Mascotas extends CI_Controller{
    ...
    public function __construct(){
        parent::__construct();
        $this->load->model('Empleado/Mascota_model');
    }
    ...
    public function index(){
        ...
        $this->load->view('Empleado/Mascota/index', $data);
    ...
    public function finadas(){
        ...
        $this->load->view('Empleado/Layout_emp/header');
        $this->load->view('Empleado/Layout_emp/menu');
        $this->load->view('Empleado/Mascota/index2', $data);
        $this->load->view('Empleado/Layout_emp/footer');
    }
    ...
    public function view($id_admin){
        ...
        $this->load->view('Empleado/Layout_emp/header');
        $this->load->view('Empleado/Layout_emp/menu');
        $this->load->view('Empleado/Mascota/view', $data);
        $this->load->view('Empleado/Layout_emp/footer');
    }
    ...
    public function viewF($id_admin){
        ...
        $this->load->view('Empleado/Layout_emp/header');
        $this->load->view('Empleado/Layout_emp/menu');
        $this->load->view('Empleado/Mascota/view2', $data);
        $this->load->view('Empleado/Layout_emp/footer');
    }
    ...
    public function newPet(){
        ...
        $this->load->view('Empleado/Layout_emp/header');
        $this->load->view('Empleado/Layout_emp/menu');
        $this->load->view('Empleado/Mascota/create', $data);
        $this->load->view('Empleado/Layout_emp/footer');         
    }
    ...
    public function nuevaMascota(){      
        ...
        if (!$this->upload->do_upload("txtFotografia")) {
            ...
            $this->load->view('Empleado/Layout_emp/header');
            $this->load->view('Empleado/Layout_emp/menu');
            $this->load->view('Empleado/Mascota/success');
            $this->load->view('Empleado/Layout_emp/footer');
        }
    }
    ...
    public function delete(){
        ...
        redirect( base_url() . 'Empleado/Mascotas');
    }
