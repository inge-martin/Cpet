...
class Expediente extends CI_Controller{
    ...
    public function __construct(){
        parent::__construct();
        $this->load->model('Empleado/Expediente_model');
    }
    ...
    public function index(){
        ...
        $this->load->view('Empleado/Expediente/index', $data);
    ...
    public function view(){
        ...
        $this->load->view('Empleado/Expediente/imprimir', $data);
    }
    ...
    public function generar(){
        ...
        $html = $this->load->view('Empleado/Expediente/imprimir', $data, true);
