...
class Clientes extends CI_Controller{
	...
	public function __construct(){
		parent::__construct();
		$this->load->model('Empleado/Cliente_model');
	}
	...
	public function index(){
		...
		$this->load->view('Empleado/Cliente/index', $data);
	...
	public function view($id_cliente){
		...
		if (empty($data['mascota'])){
			...
			$this->load->view('Empleado/Layout_emp/header');
			$this->load->view('Empleado/Layout_emp/menu');
			$this->load->view('Empleado/Cliente/add_pet');
			$this->load->view('Empleado/Layout_emp/footer');
		}else{
			$this->load->view('Empleado/Layout_emp/header');
			$this->load->view('Empleado/Layout_emp/menu');
			$this->load->view('Empleado/Cliente/view', $data);
			$this->load->view('Empleado/Layout_emp/footer');
		}
	}
	...
	public function newCli(){
		...
		$this->load->view('Empleado/Layout_emp/header');
		$this->load->view('Empleado/Layout_emp/menu');
		$this->load->view('Empleado/Cliente/create', $data);
		$this->load->view('Empleado/Layout_emp/footer');         
	}
	...
	public function nuevoCli(){
		...
		if (!$this->upload->do_upload("txtFotografia")) {
			...
			$this->load->view('Empleado/Layout_emp/header');
			$this->load->view('Empleado/Layout_emp/menu');
			$this->load->view('Empleado/Cliente/success');
			$this->load->view('Empleado/Layout_emp/footer');
		}   
	} 
