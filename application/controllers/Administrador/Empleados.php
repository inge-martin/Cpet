...
class Empleados extends CI_Controller{
    ...
    public function __construct(){
        parent::__construct();
        $this->load->model('Administrador/Empleado_model');
    }
    ...
    public function index(){
        ...
        $this->load->view('Administrador/Empleado/index', $data);
    ...
    public function view($id_empleado = NULL){
        ...
        $this->load->view('Administrador/Layout_admin/header');
        $this->load->view('Administrador/Layout_admin/menu');
        $this->load->view('Administrador/Empleado/view', $data);
        $this->load->view('Administrador/Layout_admin/footer');
    }
    ...
    public function newEmpleado(){
        ...
        $data['zootecnico'] = $this->Empleado_model->get_zootecnico();
        $data['pregunta'] = $this->Empleado_model->get_pregunta();
        $this->load->view('Administrador/Layout_admin/header');
        $this->load->view('Administrador/Layout_admin/menu');
        $this->load->view('Administrador/Empleado/create', $data);
        $this->load->view('Administrador/Layout_admin/footer');         
    }
    ...
    public function nuevoEmpleado(){
        ...
        if (!$this->upload->do_upload("txtFotografia")) {
            ...
            $paramEZ['id_zootecnico']   = $this->input->post('id_zootecnico');
            ...
            $this->load->view('Administrador/Layout_admin/header');
            $this->load->view('Administrador/Layout_admin/menu');
            $this->load->view('Administrador/Empleado/success');
            $this->load->view('Administrador/Layout_admin/footer');
        }   
    }    
